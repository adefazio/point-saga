...
if __name__ == "__main__":
    ...
    def comparison(fname, default_props):
        ...
        if subset_dataset < 1:
            ...
            order = order[:int(ceil(n*subset_dataset))]
            X = X[order,:]
            d = d[order]
        ...
        # "Point-SAGA1", "Pegasos",
        methods = ["SAGA", "SVRG", "Bregman"]

        baseline_method = "SAGA"
        propsOverrides = {"Pegasos": {}, "Pegasos avg": {'returnAveraged': True},
                         "SAGA": {}, "Point-SAGA": {}, "SDCA": {},
                         "SVRG": {'useBreg': False}, "Bregman": {'useBreg': True}, #'maxinner': 1
                         "Catalyst-SDCA": {}}
        stepSizes = {"Pegasos": [1024, 512, 128, 64, 32, 16, 8, 4, 2, 1, 0.5, 0.2, 0.1, 0.05],
                     ...
                     "SAGA": [4, 2, 1, 0.5, 0.2, 0.1, 0.05, 0.02, 0.01],
                     ...
                     "SVRG": [1, 0.5, 0.2, 0.1, 0.05, 0.02, 0.01],
                     "Bregman": [1, 0.5, 0.2, 0.1, 0.05, 0.02, 0.01],
                 }
        runFunc = {"Pegasos": pegasos, "Pegasos avg": pegasos, "SAGA": saga,
                   "Point-SAGA": pointsaga, "SVRG": bregman, "Bregman": bregman,
    ...
    fn = "plots/rcv1"
    datasetSizeSpread(fn, {'reg': 5e-5, 'dataset': 'rcv1_train.binary.mat', 'passes': 40}, hinge=False)
